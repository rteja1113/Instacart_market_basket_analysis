...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 11 09:52:13 2017
...
if __name__ == '__main__':
    ...
    order_train.to_pickle(os.path.join(path, 'order_train_shing.pkl'))
    order_test.to_pickle(os.path.join(path, 'order_test_shing.pkl'))
    ...
    ax = lgb.plot_importance(gbm, max_num_features=70, importance_type='gain', figsize=(10,10))
    ...
    result.to_pickle(os.path.join(path, 'prediction_lgbm.pkl'))
...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  9 17:54:18 2017
...
if __name__ == '__main__':
    ...
    order_comsum.to_pickle(os.path.join(path, 'orders_comsum.pkl'))
    ...
    temp.to_pickle(os.path.join(path, 'product_period.pkl'))
    ...
    aggregated.to_pickle(os.path.join(path, 'product_periods_stat.pkl'))

...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  9 17:10:11 2017
...
if __name__ == '__main__':
    ...
    labels = pd.read_pickle(os.path.join(path,'previous_products.pkl'))
    ...
    for fold in range(folds):
        ...
        print(current.shape)
        current.to_pickle(os.path.join(path, 'chunk_{}.pkl'.format(fold)))        